...
REPORT_MD = PROJECT_ROOT / "Experiment2_Report.md"
REPORT_HTML = PROJECT_ROOT / "Experiment2_Report.html"
REPORT_DOCX = PROJECT_ROOT / "Experiment2_Report.docx"
...
def markdown_to_html(markdown_text: str) -> str:
    ...
    html_lines = [
        ...
        "<head>",
        "  <meta charset='utf-8'>",
        "  <title>Experiment2 Report</title>",
        "  <style>body{font-family:Georgia,serif;max-width:900px;margin:40px auto;line-height:1.7;color:#222;padding:0 16px;} pre{background:#f5f5f5;padding:12px;overflow:auto;} code{font-family:Menlo,monospace;} h1,h2,h3{margin-top:1.4em;} </style>",
        "</head>",
        "<body>",
    ]
    in_code_block = False
...
def main() -> None:
    ...
    print(f"Generated {REPORT_MD.name}, {REPORT_HTML.name}, and {REPORT_DOCX.name}")
